...
export default function Navbar() {
  ...
  return (
    <div>
      <div className="flex items-center justify-between h-[35px] bg-violet-400 px-4 md:px-8 w-full fixed top-0 z-50 shadow-md">
        {/* Logo Section */}
        <div className="mr-[2px]">
          <img
            className="bg-[#714bb9] shadow-sm rounded-md min-w-[90px] h-[30px]"
            src={logo}
            alt="Logo"
          />
        </div>
